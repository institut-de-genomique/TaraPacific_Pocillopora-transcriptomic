...
write.table(Varpart3,sep="\t",quote=F,row.names = F,file="VarpartSubsampled_Symbiont_all.tab")
#Figure 3a
library(ggplot2)
...
Varpart3<-Varpart3[order(Varpart3$VarianceMedian,decreasing = T),]
Varpart3$Gene<-factor(Varpart3$Gene,levels=unique(Varpart3$Gene))
write.table(Varpart3,sep="\t",quote=F,row.names = F,file="VarpartSubsampled_Host_all.tab")
#Figure 3b
