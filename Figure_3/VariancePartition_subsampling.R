...
if("--help" %in% args) {
  cat("
	...
	--HostExpression FILE Table TPM normalized for the host
	--SymbiontExpression FILE Table TPM normalized for the symbiont
...
#remove I04 and keep only samples with host and symbiont gene expression data.
...
#Keep only samples with host and symbiont gene expression data.
...
for (i in 1:5){
	...
	#Expressed in 3 samples at least.
